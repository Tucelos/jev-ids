...
| `paper-llm` (`paper-llm-k0` … `paper-llm-k16`, one run directory per k, run in parallel with `make -j`) | `llm:openai`, `gpt-5.6-luna` through Agno            | 0, 1, 2, 4, 8, 16   | 0, 1, 2 | 36,000 |
